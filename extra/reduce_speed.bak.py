  ...
  with Context(SPLIT_REDUCEOP=0):
    ...
    for i, ei in enumerate(sis):
      ...
      if i == 0:
        ...
        # change the assembly
        # prg._prg = CPUProgram(dev=prg.dev, name=prg_spec.name, lib=arm_bytecode)
        # print("buffer at:",hex(ctypes.addressof(ei.bufs[1]._buf)))  # commented out - doesn't work with HCQBuffer
